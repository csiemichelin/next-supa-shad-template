      ...
      <SheetContent className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-y-auto py-6 space-y-4">
          {items.map((item) => (
            <div
              key={item.name}
              className="flex flex-row items-start lg:items-center gap-4 p-4 bg-muted/50 rounded-lg"
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex items-center gap-1 justify-end lg:hidden">
                  <Button
                    size="icon"
                    variant="outline"
                    className="h-8 w-8"
              ...
              {/* 桌機版 */}
              <div className="hidden lg:flex items-center gap-1 flex-shrink-0 w-32 justify-end">
                <Button
                  size="icon"
                  variant="outline"
                  className="h-8 w-8"
